...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="<?= site_url('pembayaran');?>"><i class="menu-icon fa fa-money"></i>Pembayaran</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card"> 
                            ...
                            <div class="card-body">
                                <button class="btn btn-success" onclick="add_pembayaran()"><i class="fa fa-plus"></i> Add</button>
    ...
    <?php 
        ...
        $this->load->view("pembayaran/_script.php"); 
        $this->load->view("pembayaran/_form.php"); 
