...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="<?= site_url('soal');?>"><i class="menu-icon fa fa-puzzle-piece"></i>Soal</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card"> 
                            <div class="card-header">
                                <strong class="card-title">Data Soal</strong>    
                            </div>
                            <div class="card-body">
    ...
    <?php 
        ...
        $this->load->view("soal/_script.php"); 
        $this->load->view("soal/_form.php"); 
